...
수익과 손익분기는 참고 자료이며 제품 방향을 뒤집거나 출시를 중단하는 기준으로 사용하지 않는다.
...
수익 극대화는 프로젝트 성공 조건이 아니며 **수익화하지 않는 선택도 허용한다.**
...
- 기획·아트·Unity·모바일 최적화·배포 과정을 포트폴리오로 설명 가능
- 수익 규모와 무관하게 과도한 부채·구독·외주비 없이 완성
