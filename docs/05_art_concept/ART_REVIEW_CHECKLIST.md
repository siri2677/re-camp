...
| CHA-A11 | 일반 등신 2D와 5~6등신 스타일라이즈드 3D의 용도가 혼동되지 않음 | Scope Assessment | |
...
- 최종 인게임 3D를 5~6등신 범위 밖으로 제안함. 2~3등신 유아형 치비와 현실적인 6~7등신 모델을 포함
...
| UIV-A04 | 공격·회복·보호막·위험 피드백를 정지 화면에서도 구분 | 기능 비교 | |
...
| CHA-B03 | 5~6등신 스타일라이즈드 체형에서 성인 여성 가독성과 공용 Humanoid 관절 확보 | 비율 가이드 | |
| CHA-B04 | 어깨·팔꿈치·손목·골반·무릎의 주요 포즈가 의상과 충돌하지 않음 | 포즈 Blockout | |
| CHA-B05 | 얼굴·눈·헤어·의상·장비 Material 슬롯이 분리 가능 | 재질표 | |
| CHA-B06 | 머리·손·발·무기 강조가 카메라·리그·애니메이션을 막지 않음 | 3DNotes | |
