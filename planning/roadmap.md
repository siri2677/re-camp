...
| 저장 | 로컬 저장 |
| 그래픽 | 3D 쿼터뷰·툰 셰이딩, 2D 일반 등신, 3D 4~5등신 SD-lite |
...
- 3D 4~5등신 SD-lite 모델, 공용 Humanoid Rig, BlendShape
...
- 공용 4~5등신 Base Mesh, Humanoid Rig, Toon Shader, Animator, 물리 본·Collider·LOD, Prefab 템플릿
