...
## ART-16. 레퍼런스 품질·성인 여성 매력 Alignment

| ID | 작업 | 상태 | 완료 기준 |
|---|---|---|---|
| ART-1510 | 사용자 지정 레퍼런스 품질 매트릭스와 5인 매력·여성성 재검토 | In Progress | ART_DIRECTION.md v2.2와 ART_REVIEW_CHECKLIST.md v2.2 기준으로 5인 REVIEW 패키지 재검토, 필요한 교정 버전·metadata·사람 Gate A 기록 |

사람 승인 전에는 기존 5인 자산을 APPROVED로 올리지 않는다. 특정 작품의 고유 얼굴·의상·무기·포즈·UI·로고를 복제하지 않으며, 상세 순서는 planning/DESIGN_DIRECTION_2026-08-09.md를 따른다.
