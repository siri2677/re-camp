...
| ART-0112 | 2D→3D 변환표 Proof | Todo | 선택 후보의 단순화·물리 위험 기록 |
...
| ART-1004 | Turnaround | In Progress | Front·Side·Back 일치 |
| ART-1005 | 표정 시트 | In Progress | 평상시·임무 대비 포함 |
| ART-1006 | 대표 장비 상세 | In Progress | 구조·활성 상태·Socket·단순화 기록 |
| ART-1007 | 컬러·재질 | In Progress | 공통 Art Direction과 일치 |
| ART-1008 | 2D→3D 변환표 | In Progress | 확대·삭제·결합·물리 제거 |
...
| ID | 작업 | 상태 | 완료 조건 |
|---|---|---|---|
| ART-1101 | 전신 후보 3안 | Ready | 동일 Character Anchor로 3안 + metadata |
...
| ID | 작업 | 상태 | 완료 조건 |
|---|---|---|---|
| ART-1201 | 전신 후보 3안 | Ready | 동일 Character Anchor로 3안 + metadata |
| ART-1202 | 얼굴·헤어 선택 | Todo | 128px 얼굴 비교 + 사람 선택 |
| ART-1203 | 패션·체형·실루엣 | Todo | 장비 on/off 비교 |
...
| ID | 작업 | 상태 | 선행 조건 |
|---|---|---|---|
| ART-2001 | 3D Presentation 계약 | Todo | ART-1009 |
