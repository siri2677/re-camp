# Battle Vertical Slice Concept Metadata
...
Tool/Model: Codex imagegen / model identifier not exposed
Workflow Version: One-shot text-to-image prompt v001
Seed: Not available
Input References: None
Human Edits: None recorded
Usage Restriction: Primary direction reference, not a final production sheet or release asset; exact face, body, costume, weapon, and topology require separate approval
Reviewer: Pending
```
...
| Final game or marketing asset | WIP | 사용 금지 | 인간 승인과 권리 검토를 통과하지 않은 생성 이미지 |

## License and Terms Check

| Check | Result | Evidence |
|---|---|---|
| 생성 도구 이용 약관 확인 | Pending | 확인 기록 없음 |
| 상업적 사용 허용 여부 확인 | Pending | 확인 기록 없음 |
| 입력 레퍼런스 권리 확인 | Not applicable | 입력 레퍼런스 없음 |
| 출시 자산 사용 승인 | Not approved | 환경 구도 참고용 REVIEW 상태 |
