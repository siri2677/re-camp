# CH101-CH105 Roster Face128 REVIEW v001 - Metadata

| Field | Value |
|---|---|
| Asset | `CH101-105_Roster_Face128_REVIEW_v001.png` |
| Scope | Exact 128px face-cell comparison for current-roster Gate A review |
| Source set | CH101/CH102 exact Face128 support plus CH103/CH104/CH105 Face128 support boards |
| Source commit | `418ef96` - `art: refine current roster gate A visuals` |
| Backlog | `ART-1502`, supports `ART-1402` |
