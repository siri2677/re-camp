...
Global product, platform, roster, visual, and Gate decisions belong to `docs/00_project/CURRENT_PROJECT_BASELINE.md`; read that canonical file instead of restating them here. Treat current primitives and gray-box visuals as implementation scaffolding, not final art.
