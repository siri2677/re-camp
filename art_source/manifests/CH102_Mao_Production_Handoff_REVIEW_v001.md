...
- `CHA-B02` Equipment structure and state transitions: `READY FOR GATE B REVIEW` - equipment detail and A/B/C state evidence exist; socket and collider proof remain.
