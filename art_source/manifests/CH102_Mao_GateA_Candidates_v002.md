...
- 기준 인물: `CH101-105_Roster_FaceDiversity_WIP_v003.png`의 왼쪽에서 두 번째 인물.
- 얼굴: 반쯤 감긴 보라 눈, 창백한 성인 여성 얼굴, 차분한 표정.
- 헤어: 허리 아래로 흐르는 긴 실버 라벤더 헤어와 긴 사이드 프린지.
- 체형: 성인 여성의 곡선형 메이커 실루엣과 긴 다리 비율.
- 의상: 블랙 크롭 하이넥 이너, 비대칭 블랙·퍼플 재킷, 보라 사이드 패널, 블랙 쇼츠와 허벅지 스트랩, 퍼플·블랙 레이스업 부츠.
- 장비: 대형 다크 퍼플 기계식 컴파운드 보우와 각진 하드웨어.
- 팔레트: 블랙·차콜·퍼플·실버 라벤더·소량의 골드 하드웨어.

## 2. Forbidden visual drift

- 오전 커밋 이미지와 다른 짧은 보브, 산성 레몬 언더라이트, 산업용 바이올렛 워크 재킷으로의 변경.
- 레깅스 중심 실루엣, 링형 구조 프레임, 거대 갑옷, 총기·저격총.
- 전투 드론 2기 등 Legacy 미유 회귀.
- 대칭 작업복 또는 교복 인상.
- 유아형 신체, 얼굴을 가리는 장비, 외부 IP 고유 디자인 복제.

## 3. Candidate package

```text
art_refs/characters/mao/concept/CH102_Mao_GateA_Candidates_WIP_v002.png
art_refs/characters/mao/concept/CH102_Mao_GateA_Candidates_WIP_v002.metadata.md
art_refs/characters/mao/concept/CH102_Mao_GateA_Candidates_WIP_v002.review.md
art_refs/characters/mao/concept/CH102_Mao_GateA_Candidates_REVIEW_v002.png
art_refs/characters/mao/concept/CH102_Mao_GateA_Candidates_REVIEW_v002.metadata.md
