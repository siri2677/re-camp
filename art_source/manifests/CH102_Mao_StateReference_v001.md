...
> Status: `APPROVED / unified state package / Gate B pending`
...
> Approved sheet: `art_refs/characters/mao/concept/CH102_Mao_CharacterSheet_APPROVED_v001.png`
> Approval record: `art_source/manifests/CH102_Mao_Production_Sheet_Approval_20260811.md`
...
5. Gate A approval applies to the unified package, not to one isolated state; the approval is recorded in the production-sheet approval manifest.
